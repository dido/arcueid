...
** TODO Runtime Built-In Functions [4/17]
   ...
   - [-] Type handling [1/2]
     - [ ] coerce [0/45]
       ...
       - [ ] rational -> string
	     Has extra argument specifying base
       - [ ] rational -> fixnum
	     May return a bignum if required by magnitude of rational
       - [ ] rational -> bignum
	     May return a fixnum if precision is not required
       - [ ] rational -> int
       ...
       - [ ] needed -> string
	     Has extra argument specifying base
       - [ ] flonum -> fixnum
	     May return a bignum if required by magnitude
       - [ ] flonum -> bignum
	     May return a fixnum if magnitude is not needed
       - [ ] flonum -> int
       ...
       - [ ] flonum -> string
       - [ ] complex -> fixnum
	     Real part by default.  Extra argument may specify 're
	     or 'im converting to real or imaginary part.  As
	     usual, may return bignum if precision required.
       - [ ] complex -> bignum
       ...
       - [ ] string -> fixnum, base specified as optional arg (same as
             string -> int)
       - [ ] string -> bignum, base specified as optional arg (same as
             string -> int)
       ...
       - [ ] cons -> vector
       - [ ] cons -> string (only for lists of chars)
       - [ ] vector -> cons
       - [ ] vector -> string (only for a character vector)
       - [ ] symbol -> string
     - [X] type
   - [X] Predicates [9/9]
     - [X] Less-than (<) *
   ...
   - [-] Math operations [4/7]
     ...
     - [-] Arc3-current functions [1/5]
       - [X] expt
       - [ ] mod
       - [ ] rand
       - [ ] sqrt
       - [ ] trunc
     - [ ] Complex arithmetic [0/5]
       - [ ] real
       - [ ] imag
       - [ ] sreal
       - [ ] simag
       - [ ] conjugate
     - [-] C99 math.h functions (Arcueid only) [1/37]
       - [ ] acos
       - [ ] acosh
       - [ ] asin
       - [ ] asinh
