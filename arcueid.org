...
** TODO base virtual machine [3/4]
   ...
   should probably write our own interpreter core directly.
    ...
    - [-] Implement simple virtual machine [36/38]
      - [X] nop
      - [X] push
      - [X] pop
      - [X] ldl
...
** TODO compiler seems to find patch offsets erroneously. [0/2]
   - [ ] Check instances of patch-code
   - [ ] Check definition of patch-code to see if it's doing things right
