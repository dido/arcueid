...
** TODO basic data types [11/14]
    ...
    - [X] Output Ports
    - [ ] Threads
** TODO Runtime Built-In Functions [9/17]
...
** TODO Macros
   It seems that implementing macros may have to require some work
   in the VM and the compiler as well.  I lean more to macros getting
   executed only at compile time for performance reasons.
