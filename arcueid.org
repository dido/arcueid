...
** TODO Runtime Built-In Functions [4/17]
   ...
   - [-] Type handling [1/2]
     - [-] coerce [1/10]
       ...
       - [-] Flonum conversions [3/5]
         ...
         - [ ] string -> flonum
	       ...
	       Arcueid allows alternate use of an '&' character to denote
               exponents (after Simula).  The strings '±inf' and 'nan' with
               any capitalization, with or without a trailing .0, will
               create an infinity or a NaN.
       ...
       - [ ] string -> num
	     Converts any string into a number of the appropriate type.
     - [X] type
   - [X] Predicates [9/9]
     - [X] Less-than (<) *
     - [X] Greater-than (>) *
