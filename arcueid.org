...
** TODO basic data types [11/14]
    ...
    - [X] Output Ports
    - [ ] Threads
** TODO Runtime Built-In Functions [2/17]
...
* Bugs
** TODO seek/tell may have 32/64 bit compatibility issues [MEDIUM]
...
** DONE compiler seems to find patch offsets erroneously. [3/3] [BLOCKER]
...
** DONE destructuring bind arguments aren't compiled correctly [BLOCKER]
** TODO try to remove the consr instruction somehow [MINOR]
   This is just an ugly bit of work and it's probably slow, but I
   can't be bothered to fix it
** TODO negative immediate values don't compile correctly [BLOCKER]
