...
/* XXX - apply should do something */
/* Type for fixnums */
arctype __arc_fixnum_t = { NULL, NULL, __arc_immediate_hash, NULL, NULL, NULL, NULL };
...
/* Type for flonums */
arctype __arc_flonum_t = { NULL, NULL, flonum_hash, flonum_iso, flonum_iso, NULL, NULL };
